...
| [docs/SECURE_BOOT_ADAPTER.md](docs/SECURE_BOOT_ADAPTER.md) | Design for the Secure Boot Adapter (`bcs.platform.adapters.secureboot`), a read-only firmware Secure Boot state wrapper and the third Host Discovery adapter; fully implemented |
