...
| [docs/EFI_ADAPTER.md](docs/EFI_ADAPTER.md) | Design for the EFI Adapter (`bcs.platform.adapters.efi`), a read-only firmware boot configuration wrapper and the first Host Discovery adapter (see [ADR-0010](docs/decisions/0010-efi-adapter-read-only-scope.md), Accepted, not yet implemented) |
