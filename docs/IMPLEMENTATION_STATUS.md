...
| Network | ✅ | ✅ | ✅ | ✅ | ❌ (still uses `sysfs` collector) | ✅ Wired (sysfs) | ✅ (models + adapter; `errors`/`parser` transitively only) | [NETWORK_ADAPTER.md](NETWORK_ADAPTER.md) — Accepted |
