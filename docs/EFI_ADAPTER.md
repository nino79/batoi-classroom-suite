...
- **Real fixture capture** — this design assumes fixtures will be captured from real hardware/VMs; none are captured yet (this is a documentation-only pass, per this document's status banner).
