...
This Code of Conduct applies within all community spaces (issues, pull requests, discussions, and any other official BCS communication channels), and also applies when an individual is officially representing the community in public spaces.

## Enforcement

Instances of abusive, harassing, or otherwise unacceptable behavior may be reported to the project maintainers by opening a confidential report via [GitHub's private reporting features](https://github.com/nino79/batoi-classroom-suite/security/advisories/new) or by contacting a maintainer directly through their GitHub profile. All complaints will be reviewed and investigated promptly and fairly.
